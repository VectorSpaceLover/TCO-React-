...
class Awards extends Component {
  ...
  componentWillMount() {
    ...
    axios({
      ...
      this.setState({years: AwardYears[AwardYears.length - 1].Year});
      this.getCsvData(GLOBAL.SITE_URL + this.state.AwardYears[AwardYears.length - 1].CSVFile.url);
      })
                ...
                <div id="pastwinner" className="award_nominees_section nominee_cur">
                  <div className="container">
                    ...
                    >
                      ...
                      {this.state.AwardYears.map((item, index) => 
                        {
                          return (
